<template>
  <div class="kanban">
    ...
    <b-modal ref="create-task-modsl" title="BootstrapVue">
      <input
...
export default {
  ...
  methods: {
    create_task(index_column) {
      ...
      this.$refs["create-task-modsl"].show();
    },
    submit_create_task() {
...
.column {
  ...
  margin: 25px;
  padding: 6px;
  -webkit-box-shadow: 22px 10px 5px 0px rgba(0, 0, 0, 0.75);
  -moz-box-shadow: 22px 10px 5px 0px rgba(0, 0, 0, 0.75);
